...
public class GadgetShopGUI implements ActionListener
{
    ...
    {
        GadgetShopGUI aGadgetShop=new GadgetShopGUI() ;
    }
    ...
    private void makeFrame()
    {
        ...
        makeACall.setBackground(Color.LIGHT_GRAY);
        addMobileButton.setForeground(Color.BLACK);
        addMobileButton.setBackground(Color.LIGHT_GRAY);
        addMP3Button.setForeground(Color.BLACK);
        addMP3Button.setBackground(Color.LIGHT_GRAY);
        viewAll.setForeground(Color.BLACK);
        viewAll.setBackground(Color.LIGHT_GRAY);
